...
public class telaEscolha extends javax.swing.JFrame {
    ...
    public telaEscolha() {
        ...
        try {
            ...
            System.out.println("Erro ao carregar as máquinas.");
    ...
    private void carregarMaquinas() throws SQLException {
        ClsBD objBD = new ClsBD();
        ResultSet retorno;
        retorno = objBD.consulta();

        while (retorno.next()) {
            cbEscolhaMaquina.addItem(retorno.getString("nomeMaquina"));
        }
    }
